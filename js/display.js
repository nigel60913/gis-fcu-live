...
import { bootDisplayLottery } from "./display-lottery.js?v=1.0.0";
...
function idle() {
  ...
  screen.innerHTML = `<section class="esg-lobby"><div class="lobby-aurora" aria-hidden="true"><i></i><i></i><i></i></div><div class="lobby-grid" aria-hidden="true"></div><div class="lobby-orbit" aria-hidden="true"><i></i><i></i><i></i></div><header class="lobby-head"><div class="display-brand lobby-brand"><img class="brand-logo" src="assets/logo.png" alt="GIS.FCU"><span>ESG × MM<small>LIVE ENGAGEMENT</small></span></div><div class="lobby-status"><i></i><span>等待開始</span></div></header><div class="lobby-content"><div class="lobby-copy"><span class="lobby-kicker">TOGETHER FOR A BETTER FUTURE</span><h1>聽見聲音<br><em>Think Together</em></h1><p>活動即將開始，掃描 QR Code 加入即時互動，<br>和我們一起為永續未來發聲。</p><div class="esg-pillars"><article><b>E</b><span><strong>ENVIRONMENT</strong>環境永續</span></article><article><b>S</b><span><strong>SOCIAL</strong>社會共好</span></article><article><b>G</b><span><strong>GOVERNANCE</strong>責任治理</span></article><article><b>M</b><span><strong>MEDIA</strong>數位媒體</span></article><article><b>M</b><span><strong>MARKETING</strong>行銷宣傳</span></article></div></div><aside class="lobby-join"><div class="lobby-qr-frame"><div id="joinQr" class="join-qr"></div><span class="qr-corner qr-corner-a"></span><span class="qr-corner qr-corner-b"></span></div><span class="eyebrow">SCAN TO JOIN</span><h2>掃描加入活動</h2><p>${escapeHtml(audienceUrl())}</p><div class="join-pulse"><i></i><span>Live session is ready</span></div></aside></div><footer class="lobby-footer"><span>ESG × MM INTERACTIVE EXPERIENCE</span><span>活動即將開始</span></footer></section>`;
  if (window.QRCode) {
...
function lottery() {
  ...
  bootDisplayLottery().catch((error) => console.error("Lottery failed to load", error));
}
